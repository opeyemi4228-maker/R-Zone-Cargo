...
export const ARTICLES = [
 ...
 excerpt:
 "Ship your car from the UK to Nigeria by RORO or container from around £650. Indicative prices, the 15-year import age limit, customs duty and the full process, explained.",
 author: "R-Zone Cargo Team",
 date: "6 August 2026",
 readTime: "8 min read",
 ...
 answer:
 "Car shipping from the UK to Nigeria starts from around £650 by RORO for a standard saloon and from around £1,300 for shared-container shipping. Larger vehicles cost more. These are indicative 2026 prices; your exact cost depends on the car, the UK collection point and the destination port, so ask R-Zone for a free quote.",
 },
 {
