// app/blog/r-zone-cargo-air-freight-schedule-uk-nigeria/page.jsx
// URL: https://r-zoneenterprises.com/blog/r-zone-cargo-air-freight-schedule-uk-nigeria
// REDIRECTS FROM: /blog/rzone-expanded-air-schedule-2026
...
const article = getArticleBySlug("r-zone-cargo-air-freight-schedule-uk-nigeria");
...
export const metadata = {
  title: article.metaTitle, description: article.metaDesc, keywords: article.keywords,
  alternates: { canonical: article.canonicalUrl },
  openGraph: { type: "article", url: article.canonicalUrl, title: article.metaTitle, description: article.metaDesc, siteName: "R-Zone Cargo", images: [{ url: article.ogImage, width: 1200, height: 630, alt: article.imgAlt }], publishedTime: article.datePublished, modifiedTime: article.dateModified, tags: article.tags },
