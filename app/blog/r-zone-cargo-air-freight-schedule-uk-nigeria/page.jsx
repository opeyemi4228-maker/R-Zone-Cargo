...
export const metadata = {
 ...
 openGraph: { type: "article", url: article.canonicalUrl, title: { absolute: article.metaTitle }, description: article.metaDesc, siteName: "R-Zone Cargo", images: [{ url: article.ogImage, width: 1200, height: 630, alt: article.imgAlt }], publishedTime: article.datePublished, modifiedTime: article.dateModified, tags: article.tags },
