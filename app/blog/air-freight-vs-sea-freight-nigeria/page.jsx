// app/blog/air-freight-vs-sea-freight-nigeria/page.jsx
// URL: https://r-zoneenterprises.com/blog/air-freight-vs-sea-freight-nigeria
// REDIRECTS FROM: /blog/air-freight-vs-sea-freight-ultimate-guide
...
const article = getArticleBySlug("air-freight-vs-sea-freight-nigeria");
    ...
    <>
      ...
      <div aria-hidden="true" style={{ position: "absolute", width: "1px", height: "1px", overflow: "hidden", clip: "rect(0,0,0,0)", whiteSpace: "nowrap" }}>
        ...
        {article.content.map((s, i) => (
          <div key={i}><h2>{s.h}</h2><p>{s.body.replace(/\*\*(.*?)\*\*/g, "$1")}</p></div>
        ))}
