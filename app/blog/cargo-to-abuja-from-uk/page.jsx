// app/blog/cargo-to-abuja-from-uk/page.jsx
// URL: https://r-zoneenterprises.com/blog/cargo-to-abuja-from-uk
...
const article = getArticleBySlug("cargo-to-abuja-from-uk");
...
const schemas = [
 ...
 "@context": "https://schema.org",
 "@type": "Service",
 name: "UK to Abuja Cargo Delivery Service",
 description: "Air and sea freight cargo delivery service from the UK to Abuja FCT, Nigeria. Door-to-door service with all customs clearance included.",
 provider: ORGANIZATION_SCHEMA,
 serviceType: "Freight and Cargo",
 areaServed: [
 { "@type": "City", name: "Abuja", containedInPlace: { "@type": "Country", name: "Nigeria" } },
 { "@type": "AdministrativeArea", name: "Federal Capital Territory", containedInPlace: { "@type": "Country", name: "Nigeria" } },
 ],
 offers: {
 "@type": "Offer",
