...
const SUBSIDIARIES = [
  {
    ...
    description:
      "R-Zone Cargo is the group's flagship freight and logistics operation — connecting UK businesses and families to all 36 Nigerian states via air freight, monthly sea shipping, door-to-door delivery and specialist cargo handling since 2012.",
    icon: Package,
    ...
    highlights: ["Air freight 5–10 days", "Monthly sea sailing", "All 36 Nigerian states", "Customs clearance"],
    color: "#0818A8",
  ...
  },
  {
    ...
    description:
      "R-Zone Homes provides premium residential and commercial real estate services across Nigeria's fastest-growing cities. From off-plan investment to property management, we connect the diaspora with Nigeria's property market.",
    icon: Home,
    href: "#",
    stats: [
  ...
  },
  {
    ...
    description:
      "R-Zone Shortlets operates a curated portfolio of fully-serviced short-term apartments in Lagos, Abuja and Port Harcourt — serving business travellers, the diaspora and premium leisure guests who demand quality without compromise.",
    icon: Building2,
    href: "#",
    stats: [
      { val: "LOS",   label: "Lagos"     },
      { val: "ABJ",   label: "Abuja"     },
      { val: "PHC",   label: "Port Harcourt" },
    ],
  ...
  {
    id: "more",
    name: "R-Zone Ventures",
    category: "Emerging Ventures",
    tagline: "New verticals in development.",
    description:
      "The R-Zone International group is actively developing new business lines across fintech, trade facilitation, and professional services — all anchored in the UK–Nigeria corridor and the broader African diaspora economy.",
    icon: Zap,
    href: "#",
    stats: [
      { val: "2025+", label: "Pipeline"  },
      { val: "3+",    label: "Sectors"   },
      { val: "∞",     label: "Ambition"  },
    ],
    highlights: ["Fintech solutions", "Trade facilitation", "Professional services", "Pan-Africa vision"],
    color: "#5B21B6",
...
const GROUP_STATS = [
  ...
  { val: "4+",    label: "Business Lines",   icon: Layers,     sub: "Diversified portfolio"   },
...
const TIMELINE = [
  ...
  { year: "2014", event: "Sea freight corridor opened, monthly sailings begin", type: "expansion" },
  ...
  return (
    <h2 ref={ref} id={id} className="leading-[0.9] tracking-[-0.02em]">
      <span className={`block font-[family-name:var(--font-mont)] font-light text-[clamp(18px,3vw,32px)] mb-1 ${
        dark ? "text-white/60" : "text-gray-800"
      }`}>{serif}</span>
...
// ═══════════════════════════════════════════════════════════════════════════════
// NAVBAR — minimal group-level nav
// ═══════════════════════════════════════════════════════════════════════════════
          ...
          <Link href="/" className="flex items-center gap-3 group" aria-label="R-Zone International — home">
            ...
            <div>
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="text-white/60 font-light text-[16px] tracking-wide uppercase leading-none">International</span>
              </div>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-7" aria-label="R-Zone International navigation">
            {[
              ...
              <a key={link.label} href={link.href}
                className="text-white/48 hover:text-white text-[12.5px] font-medium tracking-[0.03em] transition-colors duration-200"
...
function Hero() {
  ...
  return (
    <section className="hero-section relative min-h-[100svh] pt-[10px] md:pt-[30px] flex flex-col justify-center overflow-hidden bg-[#000410]"
      ...
      <div className="absolute top-24 right-[8%] hidden xl:block pointer-events-none" aria-hidden="true">
        ...
        >
          <svg viewBox="0 0 200 200" className="w-full h-full absolute inset-0">
            ...
            <text className="fill-white/60 text-[13px]" style={{ fontSize: 10.5, fontFamily: "var(--font-mont)", fontWeight: 500, letterSpacing: "0.2em" }}>
      ...
      <div ref={ref} className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 pt-[100px] pb-20 w-full">
        <motion.div style={{ opacity }}>
          ...
          {/* Main headline — Cormorant + Montserrat mixed */}
          <div className="mb-8">
            <motion.p
              className="font-[family-name:var(--font-mont)] font-light text-white/45 text-[clamp(22px,3.5vw,44px)] leading-none mb-3"
          ...
          <motion.p
            className="text-white/60 text-[15px] font-[family-name:var(--font-mont)] font-light leading-relaxed max-w-xl mb-10 tracking-wide"
            initial={{ opacity: 0, y: 16 }}
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.65, delay: 0.35 }}
          >
            R-Zone International is the parent group behind R-Zone Cargo, R-Zone Homes,
            R-Zone Shortlets, and a growing portfolio of businesses built for the UK–Nigeria
            corridor and the African diaspora economy.
          </motion.p>
          ...
          >
            ...
            <a href="#about"
              className="inline-flex items-center gap-2.5 border border-white/18 hover:border-white/40 text-white/80 hover:text-white text-[12px] font-bold tracking-[0.08em] uppercase px-7 py-3.5 transition-all duration-200"
              aria-label="About R-Zone International">
              About the Group
            </a>
          </motion.div>

          {/* Subsidiary logos strip */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
...
function GroupStats() {
  ...
  return (
    <div ref={ref} className="bg-[#0818A8] relative overflow-hidden"
      role="region" aria-label="R-Zone International group statistics">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true"
        style={{ background: "radial-gradient(ellipse at 0% 50%, rgba(0,0,0,0.2) 0%, transparent 60%)" }} />
          ...
          {GROUP_STATS.map((s, i) => {
            ...
            return (
              <motion.div key={s.label} className="flex flex-col items-center text-center"
                ...
                <p className="text-white/90 text-[12px] font-semibold tracking-[0.08em] uppercase">{s.label}</p>
                <p className="text-white/70 text-[11px] font-light mt-0.5">{s.sub}</p>
              </motion.div>
            );
          })}
        </div>
...
function Companies() {
  ...
  return (
    <section id="companies" ref={ref} className="relative bg-[#000410] overflow-hidden scroll-mt-20"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 py-20 md:py-28">
        <div className="text-center mb-16">
          ...
          <motion.p className="text-white/80 text-[14px] font-light mt-5 max-w-xl mx-auto leading-relaxed"
          ...
          {SUBSIDIARIES.map((sub, i) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r ${sub.gradient} transition-all duration-500`} aria-hidden="true" />

                {/* Background glow */}
                <div className="absolute top-0 right-0 w-60 h-60 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"
                  style={{ background: `radial-gradient(circle, ${sub.color}12 0%, transparent 70%)`, transform: "translate(30%, -30%)" }}
                  aria-hidden="true"
                />

                {/* Large decorative number */}
                <div className="absolute bottom-4 right-6 font-black text-white/[0.03] leading-none pointer-events-none select-none"
                  style={{ fontSize: "clamp(60px, 10vw, 120px)" }} aria-hidden="true">
                ...
                <div className="relative z-10 p-8 md:p-10">
                  <div className="flex items-start justify-between mb-7">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 rounded-sm flex items-center justify-center flex-shrink-0"
                        style={{ backgroundColor: `${sub.color}22` }} aria-hidden="true">
                        <Icon size={20} style={{ color: sub.color }} />
                      </div>
                      <div>
                        <div className="flex items-center gap-2 mb-0.5">
                          <span className="text-[9px] font-bold tracking-[0.26em] uppercase text-white/90">{sub.category}</span>
                          {sub.badge && (
                            <span className="text-[8.5px] font-bold tracking-[0.15em] uppercase px-2 py-0.5 border rounded-full"
                              style={{ borderColor: `${sub.color}40`, color: sub.color, backgroundColor: `${sub.color}12` }}>
                              {sub.badge}
                            </span>
                          )}
                          {sub.live && (
                            <span className="flex items-center gap-1 text-[8.5px] font-bold tracking-[0.15em] uppercase text-emerald-400">
                              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400" aria-hidden="true" />Live
                            </span>
                          )}
                        </div>
                        <h3 className="text-white font-black text-[20px] tracking-[-0.015em]" itemProp="name">{sub.name}</h3>
                      </div>
                    </div>
                    {sub.href !== "#" && (
                      <a href={sub.href} target="_blank" rel="noopener noreferrer"
                        className="w-9 h-9 border border-white/[0.1] hover:border-white/30 hover:bg-white/[0.08] flex items-center justify-center transition-all duration-200 flex-shrink-0"
                        aria-label={`Visit ${sub.name} website`}>
                        <ArrowUpRight size={14} className="text-white/40 group-hover:text-white transition-colors" aria-hidden="true" />
                      </a>
                    )}
                  </div>

                  <p className="font-[family-name:var(--font-mont)] text-white/80 text-[15px] mb-3 leading-snug">{sub.tagline}</p>
                  <p className="text-white/60 text-[13px] font-[family-name:var(--font-mont)] font-light leading-relaxed mb-7" itemProp="description">
                    {sub.description}
                  </p>

                  {/* Stats row */}
                  <div className="flex gap-6 mb-6 border-t border-white/[0.06] pt-5">
                    {sub.stats.map(stat => (
                      <div key={stat.label}>
                        <p className="text-white font-black text-[18px] leading-none tracking-[-0.02em]">{stat.val}</p>
                        <p className="text-white/60 text-[9.5px] font-medium tracking-[0.12em] uppercase mt-0.5">{stat.label}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <ul className="grid grid-cols-2 gap-2 mb-6" role="list">
                    {sub.highlights.map(h => (
                      <li key={h} className="flex items-center gap-2">
                        ...
                        <span className="text-white/60 text-[12px] font-light">{h}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  {sub.live ? (
                    ...
                    <a href="#contact"
                      className="inline-flex items-center gap-2 text-[11px] font-bold tracking-[0.1em] uppercase text-white/60 hover:text-white/55 transition-colors"
...
function AboutGroup() {
  ...
  return (
    <section id="about" ref={ref} className="relative bg-white overflow-hidden scroll-mt-20"
      ...
      <div className="absolute top-0 right-0 w-[40%] h-full bg-gradient-to-l from-[#0818A8]/[0.025] to-transparent pointer-events-none" aria-hidden="true" />
          ...
          <motion.div className="lg:col-span-7"
            ...
            <div className="bg-[#000410] p-8 md:p-10 relative overflow-hidden mb-6">
              ...
              <div className="relative z-10">
                <p className="text-[9.5px] font-bold tracking-[0.3em] uppercase text-white/60 mb-7">Group Structure</p>
                    ...
                    return (
                      <div key={sub.id} className="flex flex-col items-center">
                        ...
                        <div className="border border-white/[0.08] bg-white/[0.04] p-3 text-center w-full">
                          ...
                          <p className="text-white/65 text-[10.5px] font-bold leading-tight">{sub.name.replace("R-Zone ", "")}</p>
                          <p className="text-white/60 text-[9px] font-light mt-0.5">{sub.live ? "Live" : "Upcoming"}</p>
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { flag: "🇬🇧", country: "United Kingdom", role: "Group HQ", address: "Essex, UK",     accent: "#0818A8" },
                ...
                <div key={loc.country} className="border border-gray-200 bg-gray-50 p-5 hover:border-[#0818A8]/30 transition-colors duration-200">
                  ...
                  <p className="text-[10.5px] font-bold tracking-[0.18em] uppercase mt-0.5" style={{ color: loc.accent }}>{loc.role}</p>
                  <p className="text-gray-400 text-[12px] font-light mt-1.5 flex items-center gap-1.5">
...
function GroupTimeline() {
  ...
  return (
    <section ref={ref} className="relative bg-[#000410] overflow-hidden"
            ...
            {TIMELINE.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Desktop layout */}
                  <div className={`hidden lg:flex w-full items-center gap-0 mb-0 ${isRight ? "flex-row-reverse" : "flex-row"}`}>
                    <div className={`w-[calc(50%-28px)] ${isRight ? "pl-8" : "pr-8 text-right"}`}>
                      <div className={`inline-block border px-5 py-4 ${
                        isRight ? "text-left" : "text-right"
                      } border-white/[0.08] bg-white/[0.03] hover:border-white/[0.15] hover:bg-white/[0.05] transition-all duration-200 group`}>
                        ...
                        <p className="text-white/65 text-[13px] font-medium leading-snug">{item.event}</p>
                      </div>
                    </div>
                  ...
                  <div className="lg:hidden pb-6">
                    ...
                    <p className="text-white/60 text-[13px] font-medium leading-snug">{item.event}</p>
                  </div>
                </motion.div>
              );
            })}
...
function GroupValues() {
  ...
  return (
    <section id="values" ref={ref} className="relative bg-white overflow-hidden scroll-mt-20"
          ...
          <motion.div className="lg:sticky lg:top-28"
            ...
            <motion.blockquote variants={fadeUp} custom={0.3} className="mt-10 border-l-4 border-[#0818A8] pl-6">
              <p className="font-[family-name:var(--font-mont)] text-[#0b0f1a] text-[20px] leading-snug mb-2">
                "We exist to make the UK–Nigeria opportunity real — not just possible."
              </p>
              <footer className="text-gray-700 text-[11.5px] font-normal">— R-Zone International, Mandate</footer>
            </motion.blockquote>
          </motion.div>
            ...
            {VALUES.map((v, i) => {
              ...
              return (
                <motion.div key={v.title}
                  ...
                  <div className="absolute top-0 left-0 w-0 h-[3px] group-hover:w-full transition-all duration-500"
                    style={{ backgroundColor: v.accent }} aria-hidden="true" />
                  <div className="flex items-start gap-5">
                    <div className="w-11 h-11 rounded-sm flex items-center justify-center flex-shrink-0"
                      style={{ backgroundColor: `${v.accent}10` }} aria-hidden="true">
                      <Icon size={18} style={{ color: v.accent }} />
                    </div>
                    <div>
                      <h3 className="text-[#0b0f1a] font-black text-[16px] tracking-[-0.01em] mb-2">{v.title}</h3>
                      <p className="text-gray-800 text-[13px] font-[family-name:var(--font-mont)] font-normal leading-relaxed">{v.body}</p>
                    </div>
                  </div>
                </motion.div>
              );
...
function GroupContact() {
  ...
  return (
    <section id="contact" ref={ref} className="relative bg-[#000410] overflow-hidden scroll-mt-20"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 py-20 md:py-28">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          <motion.div
            ...
            <motion.p variants={fadeUp} custom={0.15}
              className="text-white/60 text-[14px] font-[family-name:var(--font-mont)] font-light leading-relaxed mt-5 mb-8 max-w-md">
            ...
            <motion.div variants={fadeUp} custom={0.25} className="space-y-4 mb-8">
              {[
                { icon: Phone,     label: "Phone",     val: "+44 800 772 0864",              href: "tel:+448007720864",                    desc: "R-Zone Cargo / Group enquiries" },
                ...
                { icon: MapPin,    label: "HQ",        val: "Essex, United Kingdom",         href: "#",                                    desc: "Unit 10 Moorhen Yard, RM14 3TS" },
                { icon: Instagram, label: "Instagram", val: "@rzoneenterprise",              href: "https://instagram.com/rzoneenterprise", desc: "Follow for group updates" },
              ].map(c => {
                const Icon = c.icon;
                return (
                  <a key={c.label} href={c.href}
                    ...
                    <div>
                      <p className="text-white/60 text-[9.5px] font-bold tracking-[0.2em] uppercase">{c.label}</p>
                      <p className="text-white/75 group-hover:text-white text-[13.5px] font-semibold transition-colors leading-tight">{c.val}</p>
                      <p className="text-white/60 text-[11px] font-light">{c.desc}</p>
                    </div>
                  </a>
                );
              })}
          ...
          {/* Right — company quick links */}
          <motion.div
            initial={{ opacity: 0, y: 24 }} animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.7, delay: 0.3 }}>
            <p className="text-[9.5px] font-bold tracking-[0.3em] uppercase text-white/60 mb-5">Visit a Brand</p>
                ...
                return (
                  <div key={sub.id}
                    ...
                    <div className="h-[2px] absolute top-0 left-0 w-0 group-hover:w-full transition-all duration-500"
                      style={{ background: `linear-gradient(to right, ${sub.color}, ${sub.color}88)` }} aria-hidden="true" />
                    <div className="flex items-center gap-4">
                      <div className="w-9 h-9 rounded-sm flex items-center justify-center"
                        style={{ backgroundColor: `${sub.color}20` }} aria-hidden="true">
                        <Icon size={14} style={{ color: sub.color }} />
                      </div>
                      <div>
                        <p className="text-white/70 font-bold text-[14px]">{sub.name}</p>
                        <p className="text-white/60 text-[11px] font-light">{sub.category}</p>
                      </div>
                    </div>
                    {sub.live ? (
                      <a href={sub.href} target="_blank" rel="noopener noreferrer"
                      ...
                      <span className="text-white/60 text-[10px] font-bold tracking-[0.12em] uppercase">
                        {sub.badge}
                      </span>
                    )}
                  </div>
            ...
            <div className="border border-[#0818A8]/25 bg-[#0818A8]/10 p-6">
              <p className="text-[9.5px] font-bold tracking-[0.28em] uppercase text-[#1F51FF] mb-2">Ready to Ship Today?</p>
              <p className="text-white/55 text-[13px] font-light leading-relaxed mb-5">
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 bg-gradient-to-br from-[#0818A8] to-[#1F51FF] rounded-sm flex items-center justify-center" aria-hidden="true">
              ...
              <div>
                ...
                <span className="text-white/60 font-light text-[15px] uppercase">International</span>
              </div>
            </div>
            <p className="text-white/60 text-[12.5px] font-light leading-relaxed max-w-xs">
              A diversified UK–Nigeria enterprise group. Freight, real estate, accommodation and beyond.
              Founded 2012. Essex, United Kingdom.
            </p>
          </div>

          {/* Companies */}
          <div>
            <p className="text-[9px] font-bold tracking-[0.3em] uppercase text-white/60 mb-4">Our Companies</p>
            <div className="space-y-2">
              {SUBSIDIARIES.map(s => (
                <div key={s.id}>
                  {s.live ? (
                    <a href={s.href} target="_blank" rel="noopener noreferrer"
                      className="text-white/40 hover:text-white text-[12.5px] font-light transition-colors flex items-center gap-1.5"
                      aria-label={s.name}>
                      {s.name} <ExternalLink size={9} aria-hidden="true" />
                    </a>
                  ) : (
                    <span className="text-white/60 text-[12.5px] font-light">{s.name} <span className="text-[10px] ml-1 opacity-60">({s.badge})</span></span>
                  )}
                </div>
              ))}
            </div>
          ...
          {/* Contact */}
          <div>
            <p className="text-[9px] font-bold tracking-[0.3em] uppercase text-white/60 mb-4">Contact</p>
            <div className="space-y-2.5">
              <a href="tel:+448007720864" className="text-white/40 hover:text-white text-[12.5px] font-light transition-colors flex items-center gap-2"
                aria-label="Call: +44 800 772 0864">
                <Phone size={10} className="text-white/60" aria-hidden="true" />+44 800 772 0864
              </a>
              <a href="mailto:info@r-zoneenterprises.com" className="text-white/40 hover:text-white text-[12.5px] font-light transition-colors flex items-center gap-2 break-all"
                aria-label="Email: info@r-zoneenterprises.com">
                <Mail size={10} className="text-white/60" aria-hidden="true" />info@r-zoneenterprises.com
              </a>
              <a href="https://instagram.com/rzoneenterprise" target="_blank" rel="noopener noreferrer"
                className="text-white/50 hover:text-white text-[12.5px] font-light transition-colors flex items-center gap-2"
                aria-label="Instagram: @rzoneenterprise">
                <Instagram size={10} className="text-white/60" aria-hidden="true" />@rzoneenterprise
              </a>
              <p className="text-white/60 text-[12px] font-light flex items-center gap-2">
                <MapPin size={10} aria-hidden="true" />Essex, UK · Lagos, Nigeria
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex gap-5">
            <Link href="/privacy" className="text-white/60 hover:text-white/55 text-[11px] font-light transition-colors">Privacy</Link>
            <Link href="/terms" className="text-white/22 hover:text-white/55 text-[11px] font-light transition-colors">Terms</Link>
            <Link href="https://r-zoneenterprises.com" className="text-white/22 hover:text-white/55 text-[11px] font-light transition-colors">R-Zone Cargo</Link>
          </div>
        </div>
      </div>
    </footer>
  ...
  "@graph": [
    {
      ...
      "address": {
        "@type": "PostalAddress",
        "addressLocality": "Upminster", "addressRegion": "Essex",
        "postalCode": "RM14 3TS", "addressCountry": "GB",
      },
      "telephone": "+448007720864",
      "email": "info@r-zoneenterprises.com",
      "sameAs": ["https://www.instagram.com/rzoneenterprise", "https://r-zoneenterprises.com"],
      "areaServed": [
        { "@type": "Country", "name": "United Kingdom" },
        { "@type": "Country", "name": "Nigeria" },
      ],
      "subOrganization": [
        { "@type": "Organization", "name": "R-Zone Cargo",     "url": "https://r-zoneenterprises.com", "description": "UK–Nigeria freight and logistics" },
        { "@type": "Organization", "name": "R-Zone Homes",     "description": "Nigerian real estate services for diaspora" },
        { "@type": "Organization", "name": "R-Zone Shortlets", "description": "Premium serviced apartments in Nigeria" },
      ],
    },
    {
      "@type": "WebSite",
