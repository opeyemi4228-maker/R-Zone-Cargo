...
function Heading({ serif, sans, dark = true, id }) {
  ...
  return (
    <h2 ref={ref} id={id} className="leading-[0.9] tracking-[-0.02em]">
      <span className={`block font-[family-name:var(--font-mont)] font-normal text-[clamp(18px,3vw,32px)] mb-1 ${
          ...
          <nav className="hidden md:flex items-center gap-7" aria-label="R-Zone International navigation">
            {[
              ...
              <a
                key={link.label}
                href={link.href}
                className="text-white/80 hover:text-white text-[13px] font-medium tracking-[0.03em] transition-colors duration-200"
      ...
      <div ref={ref} className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 pt-[100px] pb-20 w-full">
        <motion.div style={{ opacity }}>
          ...
          >
            ...
            <span className="text-[#1F51FF] text-[13px] font-bold tracking-[0.4em] uppercase">
          ...
          <div className="mb-8">
            <motion.p
              className="font-[family-name:var(--font-mont)] font-normal text-white/80 text-[clamp(22px,3.5vw,44px)] leading-none mb-3"
          ...
          <motion.p
            className="text-white/80 text-[15px] font-[family-name:var(--font-mont)] font-normal leading-relaxed max-w-xl mb-10 tracking-wide"
          ...
          >
            <a
              href="#companies"
              className="group inline-flex items-center gap-2.5 bg-[#0818A8] hover:bg-[#0437F2] text-white text-[13px] font-black tracking-[0.1em] uppercase px-7 py-3.5 transition-all duration-200 shadow-2xl shadow-[#0818A8]/35"
            ...
            <a
              href="#about"
              className="inline-flex items-center gap-2.5 border border-white/25 hover:border-white/50 text-white/80 hover:text-white text-[13px] font-bold tracking-[0.08em] uppercase px-7 py-3.5 transition-all duration-200"
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 py-20 md:py-28">
        <div className="text-center mb-16">
          ...
          <motion.p
            className="text-white/80 text-[14px] font-normal mt-5 max-w-xl mx-auto leading-relaxed"
            initial={{ opacity: 0 }}
            animate={inView ? { opacity: 1 } : {}}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-5 right-5 flex items-end justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[13px] font-bold tracking-[0.24em] uppercase text-white/80">
                        {sub.category}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      {sub.badge && (
                        <span
                          className="text-[13px] font-bold tracking-[0.15em] uppercase px-2.5 py-1 border rounded-full"
                      ...
                      {sub.live && (
                        <span className="flex items-center gap-1 text-[13px] font-bold tracking-[0.15em] uppercase text-emerald-400 bg-emerald-400/10 border border-emerald-400/25 px-2.5 py-1 rounded-full">
                ...
                <div className="relative z-10 p-7 md:p-8">
                  ...
                  <p
                    className="text-white/80 text-[13px] font-[family-name:var(--font-mont)] font-normal leading-relaxed mb-6"
                  ...
                  <div className="flex gap-6 mb-5 border-t border-white/[0.06] pt-5">
                    {sub.stats.map(stat => (
                      <div key={stat.label}>
                        ...
                        <p className="text-white/80 text-[13px] font-medium tracking-[0.12em] uppercase mt-0.5">{stat.label}</p>
                      </div>
                    ))}
                  </div>
                  ...
                  <ul className="grid grid-cols-2 gap-2 mb-6" role="list">
                    {sub.highlights.map(h => (
                      <li key={h} className="flex items-center gap-2">
                        ...
                        <span className="text-white/80 text-[13px] font-normal">{h}</span>
                      </li>
                    ))}
                  </ul>
                  ...
                  {sub.live ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="group/cta inline-flex items-center gap-2 text-[13px] font-black tracking-[0.1em] uppercase transition-all duration-200"
                    ...
                    <a
                      href="#contact"
                      className="inline-flex items-center gap-2 text-[13px] font-bold tracking-[0.1em] uppercase text-white/80 hover:text-white transition-colors"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-14 lg:gap-20 items-start">
          ...
          >
            ...
            <motion.div variants={fadeUp} custom={0.3} className="mt-8 flex flex-wrap gap-3">
              ...
              <a
                href="#contact"
                className="inline-flex items-center gap-2 border border-[#0818A8]/25 text-[#0818A8] hover:bg-[#0818A8] hover:text-white text-[13px] font-bold tracking-[0.08em] uppercase px-6 py-3 transition-all duration-200"
          ...
          >
            ...
            <div className="bg-[#000410] p-8 md:p-10 relative overflow-hidden mb-6">
              ...
              <div className="relative z-10">
                <p className="text-[13px] font-bold tracking-[0.3em] uppercase text-white/80 mb-7">
                  Group Structure
                </p>
                    ...
                    return (
                      <div key={sub.id} className="flex flex-col items-center">
                        ...
                        <div className="border border-white/[0.08] bg-white/[0.04] p-3 text-center w-full">
                          ...
                          <p className="text-white/80 text-[13px] font-normal mt-0.5">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <p className="text-[13px] font-bold tracking-[0.18em] uppercase mt-0.5" style={{ color: loc.accent }}>
                    {loc.role}
                  </p>
                  <p className="text-gray-800 text-[13px] font-normal mt-1.5 flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-start">
          ...
          >
            ...
            <motion.blockquote variants={fadeUp} custom={0.3} className="mt-10 border-l-4 border-[#0818A8] pl-6">
              ...
              <footer className="text-gray-800 text-[13px] font-normal">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              custom={0.15}
              className="text-white/80 text-[14px] font-[family-name:var(--font-mont)] font-normal leading-relaxed mt-5 mb-8 max-w-md"
            >
          ...
          >
            <p className="text-[13px] font-bold tracking-[0.3em] uppercase text-white/80 mb-5">
              Visit a Brand
            </p>
                ...
                return (
                  ...
                  >
                    ...
                    {sub.live ? (
                      ...
                      <span className="text-white/80 text-[13px] font-bold tracking-[0.12em] uppercase">
                        {sub.badge}
                      </span>
                    )}
                  </div>
            ...
            <div className="border border-[#0818A8]/25 bg-[#0818A8]/10 p-6">
              <p className="text-[13px] font-bold tracking-[0.28em] uppercase text-[#1F51FF] mb-2">
                Ready to Ship Today?
              </p>
      ...
      <div className="max-w-[1400px] mx-auto px-5 sm:px-8 xl:px-10 py-12">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <span className="text-white/80 font-normal text-[15px] uppercase">International</span>
              </div>
            </div>
                ...
                <div key={s.id}>
                  {s.live ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-white/80 hover:text-white text-[13px] font-normal transition-colors flex items-center gap-1.5"
                      aria-label={s.name}
                    >
                    ...
                    <span className="text-white/80 text-[13px] font-normal">
                      {s.name}{" "}
                      <span className="text-[13px] ml-1 opacity-70">({s.badge})</span>
                    </span>
                  )}
                </div>
              ))}
          ...
          <div>
            ...
            <div className="space-y-2.5">
              <a
                ...
                className="text-white/80 hover:text-white text-[13px] font-normal transition-colors flex items-center gap-2"
              ...
              <a
                ...
                className="text-white/80 hover:text-white text-[13px] font-normal transition-colors flex items-center gap-2 break-all"
              ...
              <p className="text-white/80 text-[13px] font-normal flex items-center gap-2">
        ...
        <div className="border-t border-white/[0.06] pt-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex gap-5">
            <Link href="/privacy" className="text-white/80 hover:text-white text-[13px] font-normal transition-colors">
              Privacy
            </Link>
            <Link href="/terms" className="text-white/80 hover:text-white text-[13px] font-normal transition-colors">
              Terms
            </Link>
            <Link href="https://r-zoneenterprises.com" className="text-white/80 hover:text-white text-[13px] font-normal transition-colors">
              R-Zone Cargo
            </Link>
          </div>
        </div>
